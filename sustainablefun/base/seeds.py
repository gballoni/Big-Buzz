...
def populate():
   ...
   Video Quiz Questions (Appendix 10, p. 61)
    ...
    <li>The goods triangle between cotton produced in the USA, manufactured
    goods from the UK and slaves from African countries;</li>
    ...
    the contents and make divide the waste in different material categories (such as paper,
    plastic, cartons, cans, etc). After defining all the waste that could have been
